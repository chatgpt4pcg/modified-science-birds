...
public class LevelLoader
{
    ...
    {
        string levelString = GenerateXmlString(level);
        StreamWriter streamWriter = new StreamWriter(path);
        streamWriter.WriteLine(levelString);
        streamWriter.Close();
    }

    public static string GenerateXmlString(ABLevel level)
    {
    ...
    public static Dictionary<string, GameObject> LoadABResource(string path)
    {
        ...
        {
            GameObject abGameObject = objs[i];
